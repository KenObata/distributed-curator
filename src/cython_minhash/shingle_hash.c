...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [
            "/path/to/repo/terraform/text_deduplication/venv/lib/python3.13/site-packages/numpy/_core/include/numpy/arrayobject.h",
            "/path/to/repo/terraform/text_deduplication/venv/lib/python3.13/site-packages/numpy/_core/include/numpy/arrayscalars.h",
            "/path/to/repo/terraform/text_deduplication/venv/lib/python3.13/site-packages/numpy/_core/include/numpy/ndarrayobject.h",
            "/path/to/repo/terraform/text_deduplication/venv/lib/python3.13/site-packages/numpy/_core/include/numpy/ndarraytypes.h",
            "/path/to/repo/terraform/text_deduplication/venv/lib/python3.13/site-packages/numpy/_core/include/numpy/ufuncobject.h",
            "murmurhash3.h"
        ],
        "extra_compile_args": [
            "-O3",
        ...
        "include_dirs": [
            "/path/to/repo/terraform/text_deduplication/venv/lib/python3.13/site-packages/numpy/_core/include",
            "."
        ],
        "name": "shingle_hash",
        "sources": [
