...
aws s3 cp /tmp/application_1769374401406_0003.txt s3://your-scripts-bucket/log/
```
...
aws s3 cp /tmp/application_1769374401406_0008_driver.txt s3://your-scripts-bucket/log/
```
