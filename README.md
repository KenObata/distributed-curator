...
aws s3 cp s3://your-scripts-bucket/scripts/requirements.txt .
...
zip -j dependencies.zip spark_utils.py spark_partition_aware_deduplicattion_v2.py shingle_hash_wrapper.py udf.py ../test/integration_test/wet_file_utils.py
...
aws s3 cp /tmp/application_1770437151065_0002_executor.txt s3://your-scripts-bucket/log/application_1770437151065_0002_executor.txt
```
...
aws s3 cp /tmp/application_1770437151065_0002_driver.txt s3://your-scripts-bucket/log/application_1770437151065_0002_driver.txt
```

then in your local,
```
aws s3 cp s3://your-scripts-bucket/log/application_1770252307636_0002.txt .
```
...
aws s3 cp application_1770437151065_0002_1 s3://your-scripts-bucket/log/application_1770437151065_0002_1
```
then in you macbook,
```
aws s3 cp s3://your-scripts-bucket/application_1768106632592_0001_1 ~/Downloads
```
...
ssh-add ./your-emr-key.pem

# Then SSH to master with agent forwarding (-A)
ssh -A -i ./your-emr-key.pem hadoop@<master-public-ip>
